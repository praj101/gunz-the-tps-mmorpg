...
CCSurvivalRankInfo::CCSurvivalRankInfo()
{
}
...
void CCSurvivalRankInfo::ClearRanking()
{
...
bool CCSurvivalRankInfo::SetRanking( DWORD scenarioIndex, DWORD rankArrayIndex, DWORD realRank, const char* szCharName, DWORD rankPoint )
{
...
const SurvivalRanking* CCSurvivalRankInfo::GetRanking( DWORD scenarioIndex, DWORD rankIndex ) const
{
...
void CCSurvivalRankInfo::FillDummyRankingListForDebug()
{
	for (int i=0; i<MAX_SURVIVAL_SCENARIO_COUNT; ++i)
