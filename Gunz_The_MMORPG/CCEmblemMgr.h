...
protected:
	...
	time_t			m_tmLastUsed;
public:
	CCEmblemNode()			{ m_nCLID=0; m_nChecksum=0; m_szURL[0]=NULL; m_tmLastUsed=0; }
	virtual ~CCEmblemNode()	{}
...
class CCEmblemMap : public map<unsigned int, CCEmblemNode*> {};


class CCEmblemMgr {
protected:
	CCHttpSpooler	m_HttpSpooler;
	
	CCEmblemMap		m_EmblemMap;
