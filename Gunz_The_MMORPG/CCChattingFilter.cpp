...
/************************************************************************
  ...
  desc : 생성자
*************************************************************************/
CCChattingFilter::CCChattingFilter()
{
...
*************************************************************************/
bool CCChattingFilter::LoadFromFile( CCZFileSystem* pfs, const char* szFileName)
{
	if ( szFileName == 0)
		return false;
...
void CCChattingFilter::GetLine( char*& prfBuf, char* szLevel, char* szText)
{
	bool bType = true;
	int  nTypeCount = 0;
	int  nTextCount = 0;
...
void CCChattingFilter::SkipBlock( char*& prfBuf)
{
	for ( ; *prfBuf != '\n'; ++prfBuf )
		NULL;
...
/************************************************************************
  ...
  ret  : true = 허용되지 않는 특수문자를 포함하고 있음
         false = 비허용 특수문자 없음
*************************************************************************/
bool CCChattingFilter::PreTranslateStr( const string& strInText, string& strOutText)
{	
	char *pStrLowercase;
...
*************************************************************************/
bool CCChattingFilter::IsValidStr( const char* szString, unsigned int nFilteringLevel, bool bCheckSpcChar)
{
	int i, j;
	int len1, len2;
...
/************************************************************************
  ...
  ret  : filtered string
*************************************************************************/
const char* CCChattingFilter::GetLastFilteredStr()
{
...
/************************************************************************
  ...
  ret  : none
*************************************************************************/
CCChattingFilter* CCChattingFilter::GetInstance()
{
	static CCChattingFilter ChattingFilter;
...
/************************************************************************
	...
	ret  : none
*************************************************************************/
int CCChattingFilter::GetNumAbuseWords()
{
