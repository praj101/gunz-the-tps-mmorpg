...
inline void ZPostFinishedRoundInfo(const CCUID& uidStage, CCUID& uidChar, MTD_RoundPeerInfo* pPeerInfo, 
...
// 퀵조인 요청
inline void ZPostRequestQuickJoin(const CCUID& uidChar, MTD_QuickJoinParam* pParam)
{
