...
void CCAsyncDBJob_WinTheClanGame::Run(void* pContext)
{
...
bool CCAsyncDBJob_WinTheClanGame::Input(const int nWinnerCLID, const int nLoserCLID, const bool bIsDrawGame,
