...
enum CCCHANNEL_TYPE {
	CCCHANNEL_TYPE_PRESET	= 0,		// 일반채널
	CCCHANNEL_TYPE_USER		= 1,		// 사설채널
	CCCHANNEL_TYPE_PRIVATE	= 2,		// 비밀채널 - 현재 안쓰임
	CCCHANNEL_TYPE_CLAN		= 3,		// 클랜채널
	CCCHANNEL_TYPE_QUEST		= 4,		// 퀘스트채널 2006-05-23추가 - by SungE
	CCCHANNEL_TYPE_DUELTOURNAMENT = 5,	// 듀얼토너먼트채널 2009-09-21추가 - by 홍기주
	CCCHANNEL_TYPE_MAX
};
