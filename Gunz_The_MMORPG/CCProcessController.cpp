...
HANDLE CCProcessController::OpenProcessHandleByFilePath(const char* pszFilePath)
{
...
bool CCProcessController::StartProcess(const char* pszProcessPath, const BOOL bInheritHandles)
{
	BOOL bResult = FALSE;
...
bool CCProcessController::StopProcess(HANDLE hProcess)
{
